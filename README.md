...
```
3. **If you are using odysseyra1n,** install curl and libusbmuxd-tools(libusbmuxd)
...
If you're not using odysseyra1n yet and want to, keep going. Make sure you don't open the checkra1n loader app on your iPhone.
